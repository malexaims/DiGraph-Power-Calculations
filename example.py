...
G.add_node("PB4", phase=1, nodeType="bus", nomVoltage=480)
G.add_node("DS3_B", phase=1, nodeType="bus", nomVoltage=480)
G.add_node("XFMR4", phase=1, pctR=2.0, pctX=3.0, tapSetting=0.0, rating=7.5,
           nomPrimaryV=480, nomSecondaryV1=120, nomSecondaryV2=240,
           nodeType="transformer")
G.add_node("TADMS_1", nomVoltage=240, phase=1, w=2000.0, vAr=0.0, nodeType="load")
